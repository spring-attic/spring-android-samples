...
if [ ! -d "$ANDROID_HOME" ]; then
    if [[ "$OSTYPE" == "linux-gnu" ]]; then
        ...
        echo "y" | android update sdk -n -f -u -a -t tools,platform-tools,build-tools-19.0.1,build-tools-19.0.0,build-tools-18.1.1,build-tools-18.1.0,build-tools-18.0.1,build-tools-17.0.0,android-17,extra-android-m2repository,extra-android-support
